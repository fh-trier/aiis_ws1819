...
\hypersetup{
  ...
  pdftitle={Architektur/Implementierung Integrierter Systeme WS1819},
  pdfauthor={Markus Pesch},
  pdfsubject={Flucky Server},
  pdfkeywords={},
  pdfcreator={pdflatex},
...
\newminted{bash}{autogobble=true, breaklines=true, linenos=false}
...
\newmintedfile[inputbash]{bash}{autogobble=true, breaklines=true, linenos=false}
...
\newmintinline{bash}{autogobble=true, breaklines=true, linenos=false}
...
\begin{document}
  ...
  \fancyfoot[L]{Architektur/Implementierung Integrierter Systeme WS1819 - Flucky Server}
  \fancyfoot[C]{}
